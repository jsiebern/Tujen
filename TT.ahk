...
TT_Init(){ ;initialize structures function
  ...
  ,_TBBUTTON:="iBitmap,idCommand,BYTE fsState,BYTE fsStyle,BYTE bReserved[" (A_Is64bitOS=8?6:2) "],DWORD_PTR dwData,INT_PTR iString"
...
TT_Show(T,text:="",x:="",y:="",title:="",icon:=0,icon_:=1,defaulticon:=1){
  ...
  If (x="TrayIcon" || y="TrayIcon"){
    ...
    WinGet, controls, ControlList, % "ahk_id " hWndTray:=WinExist("ahk_class Shell_TrayWnd")
